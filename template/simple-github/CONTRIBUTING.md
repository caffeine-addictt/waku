...
You can also simply open an issue with the 'feature-request'
issue template. Don't forget to give the project a star!
Thanks again!
...
1. Ensure that any install or build artifacts are removed.
2. Ensure that tests and linting pass.
3. Update any documentation that may be outdated.
4. Increment version numbers according to [Semantic Versioning](https://semver.org/).
